...
#		print labels_batch
    ...
    def add_embedding(self):
        ...
        embeddings2 = tf.nn.embedding_lookup(embeddings1, self.input_placeholder)
        embeddings = tf.reshape(embeddings2, [-1, self.max_length, self.config.n_features * self.config.embed_size])
        ### END YOUR CODE
        return embeddings
